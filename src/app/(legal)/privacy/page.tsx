    ...
    return (
        <>
            ...
            <p>
                ...
                Mesynx AI service. Mesynx AI is also open-source software you
                can run yourself under the AGPL-3.0 license. If you self-host,
                your data never touches our infrastructure and this policy does
                not apply to you — see the{" "}
