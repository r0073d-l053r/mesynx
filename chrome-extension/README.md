...
By default, the extension injects on `http://localhost:8790`. If you are running Mesynx AI at a custom URL (Tailscale IP, custom domain, etc.):

1. Open the extension popup by clicking the extension icon in your toolbar.
2. Type your custom address into the **"Mesynx AI instance URL"** field (e.g. `http://100.x.y.z:8790` or `https://mesynx.example.com`).
