---
title: Self Hosting
description: Run Mesynx AI on your own infrastructure with Docker Compose.
---

Mesynx AI is AGPL-3.0 software you can run yourself. The same codebase
powers the hosted instance and self-host deployments
...
- **[Transcription server](./whisper-server)** — WhisperX setup. **Read
  this before your first transcription**: it needs an NVIDIA GPU, a
  Hugging Face token, and a one-time patch.
- **[Environment variables](./environment-variables)** — every knob
  Mesynx AI reads at boot, with required-at-runtime values called out.
