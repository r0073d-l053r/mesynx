...
Mesynx AI can notify you when a recording finishes syncing or a
...
browser prompts you for permission; Mesynx AI remembers the per-user
toggle in the database.

These only fire while the Mesynx AI tab is open in at least one
browser. For background delivery, use Bark or email.

## Email

On the hosted instance, email is already configured
...
**Settings → Notifications → Email → Enable.** Mesynx AI will send a
...
| Notification while Mesynx AI is open | Browser              |
