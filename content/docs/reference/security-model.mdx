...
Two ways to authenticate to Mesynx AI's HTTP surface:
...
| `transcriptions.speaker_names`          | Stored under `{ "c": "v1:..." }`       |
...
- Header: `X-MesynxAI-Signature: t=<unix>,v1=<hex hmac>`
...
at anything the Mesynx AI container can reach (Docker-bridge service
...
## Trust boundaries Mesynx AI does *not* own
...
- **Your AI provider.** Plaintext audio and plaintext transcripts go
  ...
  machine as your Mesynx AI instance.
...
Mesynx AI does not claim HIPAA, SOC2, or attorney-client privilege.
...
See [SECURITY.md](https://github.com/r0073d-l053r/mesynx/blob/main/SECURITY.md)
